...
COPY = {
 'en': {
  ...
  'lanes':[
   ...
   ('Organize your tabs',['All windows in one view','Topic cloud + up to 3 subcategories','Cards and pinned tabs'],'Keep lots of tabs manageable'),
 ...
 'zh-CN': {
  ...
  'lanes':[
   ...
   ('分类浏览与管理',['统一展示所有窗口的标签','主题分类云 + 最多三个二级分类','卡片浏览与固定标签'],'大量标签也能井然有序'),
